          ...
          <div className="interview-layout">
            ...
            <div className="right-panel">
              <div className="question-display">
                ...
                {/* Hint Section - Unified Logic */}
                {currentQuestion?.type === 'code' && (
                  <div className="hint-section" style={{ marginTop: '15px' }}>

                    {/* Scenario A: Detailed Hints (Level 1 & 2) */}
                    {(currentQuestion.hint1 || currentQuestion.hint2) ? (
                      <>
                        ...
                        {hintsRevealed < 1 && currentQuestion.hint1 && (
                          <button
                            ...
                            style={{
                              ...
                              fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px'
                            }}
                          >
                        ...
                        {hintsRevealed >= 1 && currentQuestion.hint1 && (
                          <div className="hint-display" style={{
                            ...
                            padding: '12px', borderRadius: '8px', color: '#92400e', marginBottom: '8px'
                          }}>
                      ...
                      /* Scenario B: Single Hint (Fallback) */
                      currentQuestion.hint && (
                        <>
                          {!hintVisible ? (
                            ...
                            <div className="hint-display" style={{
                              background: '#fffbeb', border: '1px solid #fcd34d',
                              padding: '12px', borderRadius: '8px', color: '#92400e'
                            }}>
            ...
            {/* Unified Hint Confirmation Modal */}
            {showHintConfirm && (
              <div className="modal-overlay" style={{
                ...
                <div className="modal-content" style={{
                  ...
                  <h3 style={{ color: 'white', marginBottom: '12px' }}>
                    {hintConfirmLevel > 0 ? `Use Hint ${hintConfirmLevel}?` : 'Use Hint?'}
                  </h3>
                  <p style={{ color: '#ccc', marginBottom: '24px' }}>
                    {hintConfirmLevel === 1 && "Using Hint 1 will verify a small score penalty (e.g. -10%)."}
                    {hintConfirmLevel === 2 && "Using Hint 2 will verify a larger score penalty (e.g. -25%) on top of previous penalties."}
                  ...
                  <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
                    ...
                    <button
                      onClick={() => {
                        if (hintConfirmLevel > 0) {
                          setHintsRevealed(hintConfirmLevel);
                          setHintsUsedCount(hintConfirmLevel);
                        } else {
                          setHintVisible(true);
                          setHintUsed(true);
                          setHintsUsedCount(prev => prev + 1); // Increment for single hint too
                        }
                        setShowHintConfirm(false);
                        setHintConfirmLevel(0);
                      }}
